...
$languageStrings = array(
	...
	'customer_portal' => 'en el "Portal del Cliente" en Mycrm',
	...
	'LBL_STATUS_CLOSED' => 'Closed',//Do not convert this label. This is used to check the status. If the status 'Closed' is changed in mycrmCRM server side then you have to change in customerportal language file also.
